...
const scrollData = [
  {
    ...
    description:
      "gain complete control over your decentralised finance.",
    mobile_img:
  ...
  },
  {
    ...
    description:
      "use your FourPi coins to participate in games and raffles to win the most exclusive rewards and cashbacks on FourPi. good luck.",
    mobile_img:
  ...
  },
  {
    ...
    description:
      "get access to the FourPi Store, a member-exclusive selection of products and experiences at special prices that complement your taste. this is the good life they speak of.",
    mobile_img:
  ...
  },
  {
    ...
    description:
      "switch to FourPi to use DeFi. this way you get, more reward points.",
    mobile_img:
